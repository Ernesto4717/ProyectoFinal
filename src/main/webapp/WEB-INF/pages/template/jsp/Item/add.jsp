...
<div class="container-center ">
	<form:form method="post" action="/jpaproject/User/update"
		...
		<div class="form-group">
			<div class="col-sm-4">
				<label for="Username" class="sr-only">Username</label> <input
					...
					name="username" value="${map.users.username}" readonly="readonly">
			</div>
			<div class="col-sm-4">
				<label for="password" class="sr-only"></label> <input
					type="password" class="form-control input-group-lg" name="password"
		...
		<div class="form-group">
			<div class="col-sm-8">
				<label for="Status" class="sr-only">Status:*</label> <select
